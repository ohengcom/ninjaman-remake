...
async function makeForest() {
  ...
  await img.write('phaser/public/assets/backgrounds/bg_forest.png');
}
...
async function makeBeach() {
  ...
  await img.write('phaser/public/assets/backgrounds/bg_beach.png');
}
...
async function makeCastle() {
  ...
  await img.write('phaser/public/assets/backgrounds/bg_castle.png');
}
...
async function makeHeroSheet() {
  ...
  await img.write('phaser/public/assets/sprites/player_hero_hd.png');
}
