...
saveSvg('player_idle.svg', `
  ...
  <path d="M 36 28 C 18 36 6 52 -4 64 C 8 50 22 36 34 32" fill="#cc1100" opacity="0.7"/>

  <!-- Back Sheathed Sacred Katana with golden tassels -->
  <path d="M 28 32 L 8 10 L 12 6 L 32 28 Z" fill="#1c1c1c" stroke="#e5c158" stroke-width="1.8"/>
  <path d="M 5 3 L 8 6 L 3 11" fill="none" stroke="#e5c158" stroke-width="1.5" filter="url(#goldGlow)"/>
  <circle cx="8" cy="6" r="3" fill="#ffffff"/>

  <!-- Segmented Cyber-Samurai Chestpiece & Underlayer -->
  <path d="M 26 24 L 54 24 L 46 54 L 34 54 Z" fill="url(#inkWashGrad)" stroke="#e5c158" stroke-width="1.5"/>
  <!-- Calligraphy golden rib-stripes -->
  <path d="M 32 38 L 48 38 M 33 44 L 47 44" stroke="#e5c158" stroke-width="1.5" opacity="0.8"/>
  <!-- Central Glowing Spiritual Core (Circular golden Zen Enso) -->
  <circle cx="40" cy="35" r="7.5" fill="none" stroke="#e5c158" stroke-width="2.5" filter="url(#heavyGoldGlow)"/>
  ...
  <path d="M 14 18 C 14 6 66 6 66 18 Z" fill="url(#inkWashGrad)" stroke="#e5c158" stroke-width="1.5"/>
  <line x1="40" y1="6" x2="40" y2="24" stroke="#e5c158" stroke-width="1"/>
  <line x1="20" y1="14" x2="60" y2="14" stroke="#e5c158" stroke-width="0.8"/>

  <!-- V-shaped Glowing Golden Eyepiece beneath the hat shadow -->
  <path d="M 32 20 L 40 25 L 48 20" fill="none" stroke="#e5c158" stroke-width="2.5" filter="url(#heavyGoldGlow)"/>
...
saveSvg('player_run.svg', `
  <g transform="rotate(18 40 40) translate(2, 2)">
    ...
    <path d="M 34 26 C 0 24 -18 30 -32 34 C -20 20 6 18 26 20" fill="#cc1100" opacity="0.6"/>

    <!-- Sacred Sheathed Katana horizontal -->
    <path d="M 26 30 L -2 22 L 2 18 L 30 26 Z" fill="#1c1c1c" stroke="#e5c158" stroke-width="1.5"/>

    <!-- Sprinting mechanical body -->
    <path d="M 26 22 L 54 22 L 46 52 L 28 52 Z" fill="url(#inkWashGrad)" stroke="#e5c158" stroke-width="1.5"/>
    <circle cx="40" cy="33" r="6" fill="#e5c158" filter="url(#goldGlow)"/>
    
    <!-- Arm swinging -->
    <path d="M 22 24 L 8 36 L 12 42 L 26 30 Z" fill="url(#inkWashLight)"/>
    <circle cx="10" cy="39" r="3.5" fill="#e5c158" filter="url(#goldGlow)"/>

    <!-- Straw Hat tilted forward -->
    <ellipse cx="40" cy="14" rx="26" ry="7" fill="url(#inkWashLight)" stroke="#e5c158" stroke-width="2"/>
    <path d="M 14 14 C 14 2 66 2 66 14 Z" fill="url(#inkWashGrad)" stroke="#e5c158" stroke-width="1.5"/>
    <path d="M 32 16 L 40 21 L 48 16" fill="none" stroke="#e5c158" stroke-width="2.5" filter="url(#heavyGoldGlow)"/>
  </g>
`, 80, 80);
...
saveSvg('player_jump.svg', `
  ...
  <g transform="translate(0, -6)">
    ...
    <path d="M 26 18 L 54 18 L 44 48 L 30 48 Z" fill="url(#inkWashGrad)" stroke="#e5c158" stroke-width="1.5"/>
    <circle cx="40" cy="28" r="6" fill="#e5c158" filter="url(#goldGlow)"/>
    
    <!-- Tucked legs in red silk loops -->
    <path d="M 30 48 C 18 62 14 74 12 82" stroke="#cc1100" stroke-width="4.5" stroke-linecap="round"/>
    <path d="M 44 48 C 56 62 60 74 62 82" stroke="#e5c158" stroke-width="4.5" stroke-linecap="round" filter="url(#goldGlow)"/>
    
    <!-- Head tucked down inside the round straw hat -->
    <ellipse cx="40" cy="12" rx="22" ry="6" fill="url(#inkWashLight)" stroke="#e5c158" stroke-width="1.5"/>
    <path d="M 18 12 Q 40 -4 62 12 Z" fill="url(#inkWashGrad)" stroke="#e5c158" stroke-width="1.2"/>
  </g>
`, 80, 80);
...
saveSvg('player_dash.svg', `
  <g transform="translate(0, 10) rotate(90 40 40)">
    ...
    <path d="M 10 20 C 25 -8 55 -8 70 20" fill="none" stroke="#e5c158" stroke-width="2.5" filter="url(#goldGlow)" opacity="0.75"/>
    <path d="M 5 25 C 25 -18 55 -18 75 25" fill="none" stroke="#cc1100" stroke-width="3" opacity="0.8"/>
    
    <!-- Floating gold cherry petals -->
    <circle cx="20" cy="4" r="3.5" fill="#e5c158" filter="url(#goldGlow)"/>
    <circle cx="60" cy="4" r="4.5" fill="#ff5599" filter="url(#sakuraGlow)"/>
    ...
    <circle cx="40" cy="44" r="15" fill="#1c1c1c" stroke="#e5c158" stroke-width="1.5"/>
    <path d="M 40 29 A 7.5 7.5 0 0 0 40 44 A 7.5 7.5 0 0 1 40 59 A 15 15 0 0 0 40 29 Z" fill="#e5c158"/>
    <circle cx="40" cy="36.5" r="2.5" fill="#1c1c1c"/>
    <circle cx="40" cy="51.5" r="2.5" fill="#ffffff"/>
  </g>
`, 80, 80);
...
saveSvg('player_defend.svg', `
  ...
  <path d="M 22 25 L 50 25 L 44 55 L 26 55 Z" fill="url(#inkWashGrad)" stroke="#e5c158" stroke-width="1.8"/>
  <ellipse cx="36" cy="18" rx="22" ry="6" fill="url(#inkWashLight)" stroke="#e5c158" stroke-width="1.5"/>
  ...
  <circle cx="50" cy="36" r="32" fill="none" stroke="#e5c158" stroke-width="4.5" stroke-dasharray="160 40" filter="url(#heavyGoldGlow)" opacity="0.95"/>
  
  <!-- Inner Bagua symbols -->
  <circle cx="50" cy="36" r="22" fill="rgba(229, 193, 88, 0.08)" stroke="#e5c158" stroke-width="1.5" stroke-dasharray="6 3"/>
  <path d="M 50 22 C 40 22 40 36 50 36 C 60 36 60 50 50 50" fill="none" stroke="#e5c158" stroke-width="2"/>
  
  <!-- Digital brush details inside shield -->
  <circle cx="50" cy="29" r="2" fill="#e5c158"/>
  <circle cx="50" cy="43" r="2" fill="#ffffff"/>
  
  <!-- Impact spark beads -->
  <circle cx="72" cy="18" r="4.5" fill="#ffffff" filter="url(#goldGlow)"/>
  <circle cx="28" cy="48" r="4" fill="#e5c158" filter="url(#goldGlow)"/>
`, 80, 80);
...
saveSvg('player_attack.svg', `
  ...
  <path d="M 24 18 A 66 66 0 0 1 110 41 L 105 45 A 61 61 0 0 0 32 30 Z" fill="#ffffff" opacity="0.95"/>

  <g transform="translate(10, 0)">
    <!-- Ronin Attacking Body -->
    <path d="M 18 24 L 46 24 L 40 54 L 22 54 Z" fill="url(#inkWashGrad)" stroke="#e5c158" stroke-width="1.5"/>
    <ellipse cx="32" cy="16" rx="20" ry="5" fill="url(#inkWashLight)" stroke="#e5c158" stroke-width="1.2"/>
    <path d="M 12 16 Q 32 -2 52 16 Z" fill="url(#inkWashGrad)"/>
    <circle cx="32" cy="36" r="6.5" fill="#e5c158" filter="url(#goldGlow)"/>
...
saveSvg('player_uppercut.svg', `
  ...
  <path d="M 34 85 C 50 55 48 30 40 12 L 36 15 C 40 38 36 60 25 75 Z" fill="#ffffff" opacity="0.95"/>

  <!-- Floating sacred paper talismans with golden symbols -->
  <g filter="url(#goldGlow)">
    <rect x="54" y="20" width="8" height="16" rx="1.5" fill="#e5c158" transform="rotate(25 58 28)"/>
    ...
    <path d="M 67 9 Q 71 14 69 21" fill="none" stroke="#cc1100" stroke-width="1.2"/>
  </g>

  <!-- Dynamic posing body -->
  <g transform="translate(0, 10)">
    <path d="M 22 28 L 50 28 L 44 58 L 26 58 Z" fill="url(#inkWashGrad)" stroke="#e5c158" stroke-width="1.5"/>
    <ellipse cx="36" cy="20" rx="22" ry="6" fill="url(#inkWashLight)" stroke="#e5c158" stroke-width="1.5"/>
...
saveSvg('player_dive.svg', `
  <g transform="translate(0, 8) rotate(45 50 50)">
    ...
    <polygon points="80,45 135,30 130,50" fill="#cc1100" opacity="0.8"/>

    <!-- Pushing Body -->
    <path d="M 20 22 L 48 22 L 42 52 L 24 52 Z" fill="url(#inkWashGrad)" stroke="#e5c158" stroke-width="1.5"/>
    <ellipse cx="34" cy="14" rx="20" ry="5" fill="url(#inkWashLight)" stroke="#e5c158" stroke-width="1.2"/>
    ...
    <polygon points="115,40 130,47 115,55" fill="#ffffff"/>
  </g>
`, 100, 100);
...
saveSvg('player_cast.svg', `
  ...
  <g transform="rotate(12 40 40)">
    <path d="M 22 22 L 50 22 L 44 52 L 26 52 Z" fill="url(#inkWashGrad)" stroke="#e5c158" stroke-width="1.5"/>
    <ellipse cx="36" cy="14" rx="20" ry="5" fill="url(#inkWashLight)" stroke="#e5c158" stroke-width="1.2"/>
    ...
    <path d="M 74 15 A 7.5 7.5 0 0 0 74 30 A 7.5 7.5 0 0 1 74 45 A 15 15 0 0 0 74 15 Z" fill="#ffffff" opacity="0.6"/>
  </g>
`, 90, 80);
...
saveSvg('player_wave.svg', `
  <g transform="translate(10, 10)">
    ...
    <path d="M -5 10 L 25 0 Q 35 15 28 35 L -2 45 Z" fill="#ffffff" stroke="#e5c158" stroke-width="2.5" filter="url(#goldGlow)"/>
    
    <!-- Red calligraphic talisman glyphs on the scroll -->
    <path d="M 5 15 C 8 20 12 18 10 32 M 5 22 L 15 18 M 8 28 C 14 28 12 34 16 34" fill="none" stroke="#cc1100" stroke-width="2"/>
    ...
    <path d="M 20 -5 A 26 26 0 0 1 20 45 A 16 16 0 0 0 10 20 Z" fill="#ffffff" opacity="0.9"/>
    
    <!-- Swirling calligraphic ink brush stroke lines -->
    <path d="M 12 20 C -2 15 -14 25 -25 20" fill="none" stroke="#151515" stroke-width="5" stroke-linecap="round" filter="url(#inkMisty)"/>
    <path d="M 10 10 C -4 8 -16 14 -28 12" fill="none" stroke="#ff5599" stroke-width="3" stroke-linecap="round" filter="url(#sakuraGlow)"/>
    <path d="M 14 30 C 0 28 -12 34 -24 32" fill="none" stroke="#ff5599" stroke-width="3" stroke-linecap="round" filter="url(#sakuraGlow)"/>
  </g>
`, 60, 60);
...
saveSvg('player_combo1.svg', `
  ...
  <path d="M 42 38 L 114 36 M 44 40 L 110 38" stroke="#ffffff" stroke-width="1.5" opacity="0.9"/>
...
saveSvg('player_combo2.svg', `
  ...
  <path d="M 35 52 Q 58 32 86 14" fill="none" stroke="#ffffff" stroke-width="2" opacity="0.9"/>

  <g transform="rotate(-8 40 40)">
    <path d="M 22 24 L 50 24 L 44 54 L 26 54 Z" fill="url(#inkWashGrad)" stroke="#e5c158" stroke-width="1.5"/>
    <ellipse cx="36" cy="16" rx="20" ry="5" fill="url(#inkWashLight)" stroke="#e5c158" stroke-width="1.2"/>
    <!-- Uppercut swing arm -->
...
saveSvg('player_combo3.svg', `
  ...
  <circle cx="40" cy="40" r="36" fill="none" stroke="#ffffff" stroke-width="1.8" opacity="0.9" stroke-dasharray="80 140"/>
...
saveSvg('player_combo4.svg', `
  ...
  <path d="M 34 -2 L 36 -2 L 46 68 L 26 68 Z" fill="#ffffff" opacity="0.9"/>

  <!-- Blinding energy rings at ground impact -->
  <ellipse cx="36" cy="64" rx="30" ry="9" fill="none" stroke="#e5c158" stroke-width="3" filter="url(#goldGlow)" opacity="0.95"/>
  <ellipse cx="36" cy="64" rx="18" ry="4.5" fill="#ffffff" filter="url(#heavyGoldGlow)"/>
  
  <!-- Calligraphy lightning fragments -->
  <line x1="16" y1="68" x2="-6" y2="75" stroke="#e5c158" stroke-width="4.5" stroke-linecap="round" filter="url(#goldGlow)"/>
  ...
  <g transform="translate(2, 6)">
    ...
    <ellipse cx="36" cy="6" rx="20" ry="5" fill="url(#inkWashLight)" stroke="#e5c158" stroke-width="1.2"/>
...
saveSvg('enemy_guard.svg', `
  ...
  <path d="M 16 24 L 56 24 L 60 55 L 12 55 Z" fill="url(#inkWashGrad)" stroke="#cc1100" stroke-width="2.5"/>
  <path d="M 12 55 L 60 55 L 56 68 L 16 68 Z" fill="#cc1100" stroke="#151515" stroke-width="1"/>
  
  <!-- Glowing orange panel lines -->
  <path d="M 22 34 L 50 34 M 24 42 L 48 42 M 26 50 L 46 50" stroke="#cc1100" stroke-width="1.8"/>
  <circle cx="36" cy="38" r="6" fill="#e5c158" filter="url(#goldGlow)"/>
  
  <!-- Cyber samurai helm with glowing optic sensor -->
  <rect x="24" y="8" width="24" height="16" rx="2" fill="#1c1c1c" stroke="#cc1100" stroke-width="1.5"/>
  ...
  <rect x="56" y="16" width="4" height="48" fill="#333" stroke="#cc1100" stroke-width="0.8"/>
...
saveSvg('enemy_axe.svg', `
  ...
  <rect x="12" y="16" width="56" height="54" rx="10" fill="url(#inkWashGrad)" stroke="#800000" stroke-width="3.5"/>
  
  <!-- Glowing mechanical red Sanskrit/Zen signs on chest -->
  <path d="M 26 26 L 42 26 M 34 26 L 34 40 M 26 40 L 42 40 M 26 33 L 42 33" stroke="#cc1100" stroke-width="2.5" filter="url(#redGlow)"/>
  <path d="M 28 46 L 50 46 M 39 46 L 39 58" stroke="#cc1100" stroke-width="2.5" filter="url(#redGlow)"/>
  
  <!-- Large heavy stone joints -->
  <circle cx="12" cy="43" r="8.5" fill="#151515" stroke="#cc1100" stroke-width="1.8"/>
  <circle cx="68" cy="43" r="8.5" fill="#151515" stroke="#cc1100" stroke-width="1.8"/>

  <!-- Head with glowing red evil gaze visor -->
  <polygon points="30,16 50,16 46,6 34,6" fill="#151515" stroke="#cc1100" stroke-width="1.5"/>
  <circle cx="40" cy="11" r="3.5" fill="#ff2200" filter="url(#redGlow)"/>

  <!-- Colossal Lacquered Executioner Axe -->
  <rect x="68" y="2" width="7" height="74" fill="#151515" stroke="#800000" stroke-width="1.5"/>
  ...
  <path d="M 72 18 Q 105 10 105 35 Q 105 60 72 52 Z" fill="#ffffff" opacity="0.85"/>
`, 110, 80);
...
saveSvg('enemy_ninja.svg', `
  ...
  <line x1="40" y1="16" x2="40" y2="55" stroke="#cc1100" stroke-width="1.2"/>

  <!-- Spherical head with glowing golden paper mask eyepiece -->
  <circle cx="40" cy="11" r="9" fill="#ffffff" stroke="#e5c158" stroke-width="1.8"/>
  <polygon points="36,8 44,8 40,14" fill="#e5c158" filter="url(#goldGlow)"/>
  <circle cx="40" cy="11" r="2.5" fill="#ffffff"/>
...
saveSvg('enemy_sniper.svg', `
  ...
  <line x1="22" y1="24" x2="58" y2="56" stroke="#e5c158" stroke-width="2.5"/>
  <line x1="22" y1="56" x2="58" y2="24" stroke="#e5c158" stroke-width="2.5"/>
  <rect x="30" y="32" width="20" height="16" fill="#1c1c1c" stroke="#cc1100" stroke-width="1"/>
  
  <!-- Turret neck -->
  <path d="M 28 14 L 52 14 L 46 24 L 34 24 Z" fill="#151515" stroke="#e5c158" stroke-width="1.2"/>
  <!-- Optical high-tech charging lens inside copper ring -->
  <circle cx="40" cy="19" r="6" fill="#e5c158" stroke="#1c1c1c" stroke-width="1.5"/>
  <circle cx="40" cy="19" r="2.5" fill="#ffffff" filter="url(#goldGlow)"/>

  <!-- Electromagnetic Ballista Rail-barrel -->
  <rect x="42" y="32" width="44" height="8" rx="1" fill="#111" stroke="#e5c158" stroke-width="1.2"/>
  <!-- Charging spiritual energy arrow visible in barrel -->
  <polygon points="86,36 94,36 86,40" fill="#e5c158" filter="url(#goldGlow)"/>
  <line x1="42" y1="36" x2="86" y2="36" stroke="#ffffff" stroke-width="1.8" filter="url(#goldGlow)"/>
`, 90, 80);
...
saveSvg('boss_idle.svg', `
  ...
  <circle cx="60" cy="66" r="54" fill="none" stroke="#151515" stroke-width="6" opacity="0.3" filter="url(#inkMisty)"/>

  <!-- Colossal multi-tiered pagoda shrine core structure -->
  <path d="M 8 26 L 60 6 L 112 26 L 102 98 L 18 98 Z" fill="url(#inkWashGrad)" stroke="#cc1100" stroke-width="5.5"/>
  
  <!-- Roof tiles of the Pagoda -->
  <path d="M 0 28 Q 60 0 120 28" fill="none" stroke="#e5c158" stroke-width="6"/>
  <path d="M -5 32 Q 60 4 125 32" fill="none" stroke="#cc1100" stroke-width="2"/>
  
  <!-- Swirling Bagua Glyphs around Core (乾坤震巽坎离艮兑) -->
  <!-- Active glowing symbols inside circle -->
  <circle cx="60" cy="66" r="32" fill="none" stroke="#e5c158" stroke-width="2" stroke-dasharray="15 8" filter="url(#goldGlow)"/>
  <text x="54" y="44" font-family="sans-serif" font-weight="bold" font-size="9" fill="#e5c158" filter="url(#goldGlow)">乾</text>
  <text x="54" y="96" font-family="sans-serif" font-weight="bold" font-size="9" fill="#e5c158" filter="url(#goldGlow)">坤</text>
  <text x="32" y="70" font-family="sans-serif" font-weight="bold" font-size="9" fill="#e5c158" filter="url(#goldGlow)">离</text>
  <text x="76" y="70" font-family="sans-serif" font-weight="bold" font-size="9" fill="#e5c158" filter="url(#goldGlow)">坎</text>

  <!-- Pulsing central yin-yang reactor core -->
  <circle cx="60" cy="66" r="18" fill="#1c1c1c" stroke="#e5c158" stroke-width="2" filter="url(#heavyGoldGlow)"/>
  <path d="M 60 48 A 9 9 0 0 0 60 66 A 9 9 0 0 1 60 84 A 18 18 0 0 0 60 48 Z" fill="#e5c158"/>
  <circle cx="60" cy="57" r="3" fill="#1c1c1c"/>
  <circle cx="60" cy="75" r="3" fill="#ffffff"/>
  
  <!-- Hanging paper talismans along bottom -->
  <g fill="#e5c158" stroke="#cc1100" stroke-width="0.8">
  ...
  <rect x="-14" y="26" width="30" height="52" rx="5" fill="#111" stroke="#cc1100" stroke-width="3"/>
  <rect x="104" y="26" width="30" height="52" rx="5" fill="#111" stroke="#cc1100" stroke-width="3"/>
`, 140, 120);

// Boss - Windup (Full spiritual overload, calligraphy runes bursting out)
saveSvg('boss_windup.svg', `
  <path d="M 8 26 L 60 6 L 112 26 L 102 98 L 18 98 Z" fill="url(#inkWashGrad)" stroke="#e5c158" stroke-width="5.5"/>
  <path d="M 0 28 Q 60 0 120 28" fill="none" stroke="#cc1100" stroke-width="6"/>

  <!-- Core charging yellow-hot -->
  <circle cx="60" cy="66" r="34" fill="none" stroke="#e5c158" stroke-width="4" stroke-dasharray="8 6" filter="url(#goldGlow)"/>
  
  <!-- Yin-Yang spinning actively -->
  <circle cx="60" cy="66" r="22" fill="#1c1c1c" stroke="#ffffff" stroke-width="2.5" filter="url(#heavyGoldGlow)"/>
  <path d="M 60 44 A 11 11 0 0 0 60 66 A 11 11 0 0 1 60 88 A 22 22 0 0 0 60 44 Z" fill="#e5c158"/>

  <!-- Massive glowing calligraphy signs erupting (Sanskrit/Kanji "神" / "力") -->
  <text x="32" y="42" font-family="serif" font-weight="bold" font-size="15" fill="#cc1100" filter="url(#redGlow)">神</text>
  <text x="76" y="42" font-family="serif" font-weight="bold" font-size="15" fill="#cc1100" filter="url(#redGlow)">机</text>
  <text x="32" y="96" font-family="serif" font-weight="bold" font-size="15" fill="#e5c158" filter="url(#goldGlow)">乾</text>
  <text x="76" y="96" font-family="serif" font-weight="bold" font-size="15" fill="#e5c158" filter="url(#goldGlow)">坤</text>

  <!-- Claws raised in charging pose -->
  <rect x="-20" y="8" width="30" height="52" rx="5" fill="#111" stroke="#e5c158" stroke-width="3" transform="rotate(-26 0 32)"/>
  <rect x="110" y="8" width="30" height="52" rx="5" fill="#111" stroke="#e5c158" stroke-width="3" transform="rotate(26 120 32)"/>
`, 140, 120);
...
saveSvg('boss_attack.svg', `
  ...
  <circle cx="-10" cy="30" r="4.5" fill="#151515" filter="url(#inkMisty)"/>
...
saveBgSvg('platform.svg', `
  <rect width="64" height="64" fill="url(#inkWashGrad)" stroke="#1c1c1c" stroke-width="2.5"/>
  
  <!-- Golden/copper grain lines on lacquered wood -->
  <path d="M 0 18 Q 32 12 64 18 M 0 34 Q 32 28 64 34 M 0 50 Q 32 44 64 50" stroke="#2d1d11" stroke-width="1.8"/>
  ...
  <line x1="4" y1="8" x2="60" y2="8" stroke="#e5c158" stroke-width="0.5" opacity="0.15"/>
  <line x1="4" y1="42" x2="60" y2="42" stroke="#e5c158" stroke-width="0.5" opacity="0.15"/>

  <!-- Ancient Sacred Top Edge Golden Border (The Golden Seal / 符文) -->
  <rect x="0" y="0" width="64" height="6.5" fill="#e5c158" filter="url(#bgGlow)"/>
  <rect x="0" y="0" width="64" height="2" fill="#ffffff"/>
  
  <!-- Red sacred warning symbols on the gold edge -->
  <rect x="12" y="2.5" width="4" height="2" fill="#cc1100"/>
  <rect x="30" y="2.5" width="4" height="2" fill="#cc1100"/>
  <rect x="48" y="2.5" width="4" height="2" fill="#cc1100"/>

  <!-- Copper corner reinforcement brackets and rivets -->
  <circle cx="8" cy="12" r="2.8" fill="#e5c158" filter="url(#bgGlow)"/>
  <circle cx="56" cy="12" r="2.8" fill="#e5c158" filter="url(#bgGlow)"/>
  <circle cx="8" cy="52" r="2" fill="#2d1d11"/>
  <circle cx="56" cy="52" r="2" fill="#2d1d11"/>
`, 64, 64);
...
saveBgSvg('bg_city_far.svg', `
  ...
  <circle cx="1020" cy="190" r="105" fill="#e5c158" filter="url(#bgGlow)" opacity="0.65"/>
  ...
  <g fill="#cc1100" opacity="0.65" filter="url(#bgGlow)">
    <!-- Crane 1 -->
...
saveBgSvg('bg_city_mid.svg', `
  ...
  <g fill="url(#pagodaGrad)" stroke="#e5c158" stroke-width="2">
    <!-- Pagoda 1 -->
    <rect x="50" y="280" width="130" height="440" />
    <path d="M 30 280 Q 115 220 200 280" fill="url(#pagodaGrad)" stroke="#cc1100" stroke-width="2.5"/>
    <path d="M 40 360 Q 115 310 190 360" fill="url(#pagodaGrad)" stroke="#cc1100" stroke-width="2"/>
    
    <!-- Pagoda 2 -->
    <rect x="290" y="160" width="170" height="560" />
    <path d="M 270 160 Q 375 100 480 160" fill="url(#pagodaGrad)" stroke="#cc1100" stroke-width="2.5"/>
    <path d="M 280 280 Q 375 220 470 280" fill="url(#pagodaGrad)" stroke="#cc1100" stroke-width="2"/>
    <path d="M 285 400 Q 375 340 465 400" fill="url(#pagodaGrad)" stroke="#cc1100" stroke-width="2"/>
    
    <!-- Pagoda 3 -->
    <rect x="560" y="320" width="160" height="400" />
    <path d="M 540 320 Q 640 260 740 320" fill="url(#pagodaGrad)" stroke="#cc1100" stroke-width="2.5"/>
    
    <!-- Pagoda 4 -->
    <rect x="800" y="110" width="160" height="610" />
    <path d="M 780 110 Q 880 50 980 110" fill="url(#pagodaGrad)" stroke="#cc1100" stroke-width="2.5"/>
    <path d="M 790 230 Q 880 170 970 230" fill="url(#pagodaGrad)" stroke="#cc1100" stroke-width="2"/>
    <path d="M 795 350 Q 880 290 965 350" fill="url(#pagodaGrad)" stroke="#cc1100" stroke-width="2"/>
    
    <!-- Pagoda 5 -->
    <rect x="1060" y="240" width="150" height="480" />
    <path d="M 1040 240 Q 1135 180 1230 240" fill="url(#pagodaGrad)" stroke="#cc1100" stroke-width="2.5"/>
  </g>

  <!-- Glowing spiritual paper lanterns and calligraphic typography signs -->
  <g filter="url(#bgGlow)">
    <!-- Pagoda 1 hanging lantern lights -->
    <rect x="105" y="300" width="20" height="30" rx="3" fill="#e5c158" opacity="0.9"/>
    <line x1="115" y1="300" x2="115" y2="330" stroke="#cc1100" stroke-width="1.8"/>

    <!-- Pagoda 2 Calligraphy grid -->
    <line x1="290" y1="230" x2="460" y2="230" stroke="#e5c158" stroke-width="4"/>
    <rect x="330" y="300" width="16" height="80" fill="#cc1100" opacity="0.85"/>
    <rect x="375" y="300" width="16" height="80" fill="#cc1100" opacity="0.85"/>
    <rect x="420" y="300" width="16" height="80" fill="#cc1100" opacity="0.85"/>

    <!-- Giant Calligraphic Banner Kanji "忍" and "禅" vertically -->
    <rect x="850" y="170" width="60" height="240" rx="6" fill="#f5efe0" stroke="#cc1100" stroke-width="2"/>
    <text x="862" y="225" font-family="serif" font-weight="bold" font-size="48" fill="#151515" letter-spacing="4">忍</text>
    <text x="862" y="325" font-family="serif" font-weight="bold" font-size="48" fill="#cc1100" letter-spacing="4">禅</text>

    <!-- Spiritual sacred maples flying across background -->
    <circle cx="640" cy="200" r="14" fill="#cc1100" opacity="0.85"/>
    <path d="M 625 200 L 655 200 L 640 185 Z" fill="#ffffff"/>
  </g>
`, 1280, 720);
...
saveBgSvg('bg_forest_mid.svg', `
  ...
  <g fill="#221e16" stroke="#e5c158" stroke-width="2">
    ...
    <!-- Leaf clusters -->
    <polygon points="120,180 200,90 280,180 200,140" fill="#cc1100" stroke="#e5c158" stroke-width="1.2"/>
    <polygon points="480,130 625,30 770,130 625,90" fill="#2d281e" stroke="#e5c158" stroke-width="1.2"/>
    <polygon points="780,220 910,120 1040,220 910,180" fill="#cc1100" stroke="#e5c158" stroke-width="1.2"/>
  </g>
  ...
  <g fill="#e5c158" filter="url(#bgGlow)">
    ...
    <line x1="215" y1="320" x2="215" y2="335" stroke="#cc1100" stroke-width="1.5"/>
    <line x1="625" y1="300" x2="625" y2="320" stroke="#cc1100" stroke-width="2"/>
    <line x1="912" y1="380" x2="912" y2="400" stroke="#cc1100" stroke-width="1.8"/>

    <!-- Floating spirit cherry blossom flower seeds -->
    <circle cx="280" cy="360" r="5" fill="#ff5599" filter="url(#bgGlow)"/>
    <circle cx="480" cy="460" r="4.5" fill="#ff5599" filter="url(#bgGlow)"/>
...
saveBgSvg('bg_core_mid.svg', `
  ...
  <g fill="#1a140f" stroke="#cc1100" stroke-width="3.5">
  ...
  <circle cx="640" cy="360" r="210" fill="#15120d" stroke="#e5c158" stroke-width="12"/>
  
  <!-- Glowing neon Bagua rings (rotating hazard replacement) -->
  <circle cx="640" cy="360" r="170" fill="none" stroke="#cc1100" stroke-width="4.5" stroke-dasharray="20 12" filter="url(#bgGlow)"/>
  ...
  <circle cx="640" cy="360" r="55" fill="#1c1c1c" stroke="#ffffff" stroke-width="2.5" filter="url(#bgGlow)"/>
  <path d="M 640 305 A 27.5 27.5 0 0 0 640 360 A 27.5 27.5 0 0 1 640 415 A 55 55 0 0 0 640 305 Z" fill="#e5c158"/>

  <!-- Golden sacred paper seals (符咒) hanging from temple beams -->
  <g fill="#e5c158" stroke="#cc1100" stroke-width="1" filter="url(#bgGlow)">
    <rect x="250" y="100" width="40" height="120" rx="3" fill="#f5efe0"/>
    <text x="258" y="170" font-family="serif" font-weight="bold" font-size="28" fill="#151515">符</text>
    
    <rect x="990" y="150" width="40" height="120" rx="3" fill="#f5efe0"/>
    <text x="998" y="220" font-family="serif" font-weight="bold" font-size="28" fill="#cc1100">神</text>
  </g>
`, 1280, 720);
