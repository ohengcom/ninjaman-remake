...
try {
    execFileSync('npx', ['audiosprite', '--version'], { stdio: 'ignore' });
} catch (e) {
...
try {
    execFileSync('npx', ['audiosprite', '--output', outputName, '--export', 'mp3,ogg', '--format', 'phaser3', ...inputFiles], { stdio: 'inherit' });
